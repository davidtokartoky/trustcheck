# -*- coding: utf-8 -*-
"""
Tests for metrictrust. Run with: pytest

The whole point of metrictrust is "can you trust this number?" — so it had
...
from metrictrust import TrustMonitor, Verdict
...
# keeps climbing normally — the exact false-positive risk a reviewer flagged
# in an earlier static-threshold version.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Verdict is both human-readable and machine-readable
# ---------------------------------------------------------------------------
def test_verdict_is_machine_and_human_readable():
    ...
    assert v.level in ("TRUST", "CAUTION", "DO_NOT_TRUST")
    assert "VERDICT" in str(v)
